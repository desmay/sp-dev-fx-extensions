...
export default class AppInsightsAdvancedApplicationCustomizer
    ...
    public onInit(): Promise<void> {
        ...
        var appInsights = new ApplicationInsights({
            config: {
                maxBatchInterval: 0,
                connectionString:'InstrumentationKey=74134282-0275-f4b5-9d85-80e665c7ca1d;EndpointSuffix=applicationinsights.us;IngestionEndpoint=https://usgovvirginia-1.in.applicationinsights.azure.us/;AADAudience=https://monitor.azure.us/;ApplicationId=4050f93a-7f0d-4f46-9fbc-2d88564336cd ',
